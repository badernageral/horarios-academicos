...
class Turma extends BaseModel
{
    ...
    public static function allComCurso(string $sort = 'curso_nome', string $dir = 'asc'): array
    {
        ...
        // Curso é sempre o agrupamento visual; série/período desempata dentro do curso.
        $ordem = $col === 'c.nome' ? "{$col} {$dir}, t.serie_periodo ASC" : "{$col} {$dir}, c.nome ASC, t.serie_periodo ASC";
